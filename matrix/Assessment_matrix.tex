...
\begin{enumerate}
    ...
    \item The sum of the numerator and denominator of a fraction is $18$. If the denominator is increased by \text{2}, the fraction is reduced to $\frac{1}{3}$. Find the fraction.
    
    \item Find the value of $k$ for which the system of equations $x + 2y = 5$ and $3x + ky + 15 = 0$ has no solution.
    
    \item If \text{2} tables and \text{2} chairs cost \rupee~700, and \text{4} tables and \text{3} chairs cost \rupee~1,250, then find the cost of one table.
